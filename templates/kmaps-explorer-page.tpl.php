<div id="<?php print $ajax ? $type . '-ajax' : $type . '-main' ?>">
  <!-- Column Resources  -->
  <nav class="content-resources col-xs-6 col-md-3 col-lg-2 sidebar-offcanvas equal-height">
  ...
  <!-- Column Main  -->
  <section  class="content-section col-xs-12 col-md-9 col-lg-10 equal-height">
