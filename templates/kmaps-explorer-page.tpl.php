<div id="<?php print $ajax ? $type . '-ajax' : $type . '-main' ?>">
  <!-- Column Resources  -->
  <aside class="content-resources col-xs-6 col-sm-3 col-md-2 col-lg-2 sidebar-offcanvas equal-height">
  ...
  <!-- Column Main  -->
  <section  class="content-section col-xs-12 col-sm-12 col-md-10 col-lg-10 equal-height">
