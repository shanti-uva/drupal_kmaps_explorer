...
OpenLayers.Control.CustomOverviewMap = OpenLayers.Class(OpenLayers.Control, {
    ...
    draw: function() {
        ...
        this.div.style.width = ( this.size.w + 20 ) + 'px';
        ...
        if(!this.outsideViewport) {
			...
			this.maximizeDiv.style.cssFloat = 'right';
			this.maximizeDiv.style.display = "none";
			...
			this.minimizeDiv.style.right = "";
			this.minimizeDiv.style.cssFloat = 'right';
