var ModelSearcher = {
	...
	init: function(divId, listService, treeService, options){
		...
		jQuery.getJSON(this.listService, function(data){
			...
			ModelSearcher.autocompleteInput.blur(function(){
				if(jQuery(this).val()==''){
		...
		if(arr.categories && arr.categories.category){
			...
			if(arr.categories.category && arr.categories.category[0]){
				for(var i in arr.categories.category) {
					html += '<li>';
					html += '<input type="checkbox" class="toggle"><label name="record_'+arr.categories.category[i].id+'">'+arr.categories.category[i].title+
				...
				html += '<li>';
				html += '<input type="checkbox" class="toggle"><label name="record_'+arr.categories.category.id+'">'+arr.categories.category.title+
						' ('+arr.categories.category.shape_count+'/'+arr.categories.category.feature_count+')</label>';
