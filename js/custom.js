(function ($) {
  Drupal.behaviors.kmapsExplorerCustom = {
    attach: function (context, settings) {
      ...
      $('.kmaps-list-columns').find('.kmaps-list-columns h6, .kmaps-list-columns.places-in-places .column > ul > li, .kmaps-list-columns.places-in-places .column ul > li:nth-child(-n+9)').addClass('dontsplit');
